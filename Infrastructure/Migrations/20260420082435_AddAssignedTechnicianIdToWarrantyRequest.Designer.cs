...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260420082435_AddAssignedTechnicianIdToWarrantyRequest")]
    partial class AddAssignedTechnicianIdToWarrantyRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Sales.ProductRating", b =>
                {
                    ...
                    b.HasIndex("ProductId", "VariantId", "SerialNumber", "CustomerId")
                        .IsUnique()
                        .HasFilter("[VariantId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.Sales.Warranty", b =>
                {
                    ...
                    b.HasIndex("ProductId", "VariantId", "SerialNumber")
                        .IsUnique()
                        .HasFilter("[VariantId] IS NOT NULL");
