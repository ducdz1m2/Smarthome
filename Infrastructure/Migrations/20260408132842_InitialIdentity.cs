        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddressWard = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ShippingAddressDistrict = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ShippingAddressCity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false),
                    ShippingMethod = table.Column<int>(type: "int", nullable: false),
                    StatusHistoryJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CustomDiscountPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnOrderItem_ReturnOrders_ReturnOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightFrom = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    WeightTo = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingRates_ShippingZones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    RequiresInstallation = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialsPrepared = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallationBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstallationBookings_InstallationSlots_SlotId",
                        column: x => x.SlotId,
                        principalTable: "InstallationSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstallationBookings_TechnicianProfiles_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "TechnicianProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InstallationBookings_TechnicianProfiles_TechnicianProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallationBookings_OrderId",
                table: "InstallationBookings",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationBookings_ScheduledDate",
                table: "InstallationBookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallationBookings_TechnicianProfileId",
                table: "InstallationBookings",
                column: "TechnicianProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationMaterials_BookingId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "InstallationSlots",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationSlots_TechnicianId",
                table: "InstallationSlots",
                column: "TechnicianId");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationSlots_TechnicianId_Date_IsBooked",
                table: "InstallationSlots",
                columns: new[] { "TechnicianId", "Date", "IsBooked" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReservations_OrderId",
                table: "ProductReservations",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReservations_ProductId_WarehouseId",
                table: "ProductReservations",
