...
{
    public class OrderRepository : Application.Interfaces.Repositories.IOrderRepository, Infrastructure.Repositories.Interfaces.IOrderRepository
    {
        private readonly AppDbContext _context;
        private readonly IDomainEventDispatcher _eventDispatcher;

        public OrderRepository(AppDbContext context, IDomainEventDispatcher eventDispatcher)
        {
            _context = context;
